...
def sim_water(cid,number_of_simulation):
    ...
    for uc in [0.0,0.2,0.4,0.6,0.8]:
        ...
        TC.run_simulation(clan_water,number_of_simulation,TC.AdapterBehaviorWaterfallTeam,output_fname,run_time=100)
def sim_agile(cid,number_of_simulation):
    ...
    for uc in [0.0,0.2,0.4,0.6,0.8]:
        ...
        TC.run_simulation(clan_agile,number_of_simulation,TC.AdapterBehaviorAgileTeam,output_fname,run_time=100)
